...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Montero " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"18.218.101.238:3306", "18.191.126.65:3306"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Montero is probably already running."), addrBind.ToString().c_str());
        else
